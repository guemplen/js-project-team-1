...
//5.Знайти функцію рендера і робимо там перевірку : питягуємо масив локал сторедж ,
//якщо поточний id = id з локал сторедж то додаємо клас ектів , якщо ні , то клас інектів
const refs = {
